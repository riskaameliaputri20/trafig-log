 <div class="app-menu navbar-menu">
     ...
     <div class="navbar-brand-box">
         ...
         <button
             type="button"
             class="btn btn-sm fs-20 header-item btn-vertical-sm-hover float-end p-0"
             id="vertical-hover"
         >
     ...
     <div class="dropdown sidebar-user m-1 rounded">
         ...
         >
             <span class="d-flex align-items-center gap-2">
                 <img
                     class="header-profile-user rounded"
                 ...
                 <span class="text-start">
                     ...
                     <span class="d-block fs-14 sidebar-user-name-sub-text"><i
                         ...
                         ></i> <span class="align-middle">Online</span></span>
                 </span>
             </span>
         </button>
         <div class="dropdown-menu dropdown-menu-end">
             ...
             ><i class="mdi mdi-account-circle text-muted fs-16 me-1 align-middle"></i> <span
                     class="align-middle">Profile</span></a>
             <a
                 class="dropdown-item"
                 href="apps-chat.html"
             ><i class="mdi mdi-message-text-outline text-muted fs-16 me-1 align-middle"></i> <span
                     class="align-middle">Messages</span></a>
             <a
                 class="dropdown-item"
                 href="apps-tasks-kanban.html"
             ><i class="mdi mdi-calendar-check-outline text-muted fs-16 me-1 align-middle"></i> <span
                     class="align-middle"
                 >Taskboard</span></a>
             <a
                 class="dropdown-item"
                 href="pages-faqs.html"
             ><i class="mdi mdi-lifebuoy text-muted fs-16 me-1 align-middle"></i> <span
                     class="align-middle">Help</span></a>
             <div class="dropdown-divider"></div>
             <a
                 class="dropdown-item"
                 href="pages-profile.html"
             ><i class="mdi mdi-wallet text-muted fs-16 me-1 align-middle"></i> <span class="align-middle">Balance :
                     <b>$5971.67</b></span></a>
             <a
                 class="dropdown-item"
                 href="pages-profile-settings.html"
             ><span class="badge bg-success-subtle text-success float-end mt-1">New</span><i
                     class="mdi mdi-cog-outline text-muted fs-16 me-1 align-middle"
                 ></i> <span class="align-middle">Settings</span></a>
             <a
                 class="dropdown-item"
                 href="auth-lockscreen-basic.html"
             ><i class="mdi mdi-lock text-muted fs-16 me-1 align-middle"></i> <span class="align-middle">Lock
                     screen</span></a>
             <a
                 class="dropdown-item"
                 href="auth-logout-basic.html"
             ><i class="mdi mdi-logout text-muted fs-16 me-1 align-middle"></i> <span
                     class="align-middle"
                     data-key="t-logout"
                 >Logout</span></a>
         </div>
         ...
         <div class="container-fluid">
             ...
             >
                         ...
                         <ul class="nav nav-sm flex-column">
                             ...
                             <li class="nav-item">
                                 <a
                                     ...
                                     class="nav-link"
                                 ><span data-key="t-blog">Blog</span> <span
                 ...
                 <li class="nav-item">
                     ...
                     <div
                         class="menu-dropdown mega-dropdown-menu collapse"
                         id="sidebarUI"
                     >
                         <div class="row">
                             <div class="col-lg-4">
                                 ...
                                 <ul class="nav nav-sm flex-column">
                                     ...
                                     <li class="nav-item">
                                         <a
                                             href="ui-links.html"
                                             class="nav-link"
                                         ><span data-key="t-links">Links</span> <span
                                                 class="badge badge-pill bg-success"
                                                 data-key="t-new"
                                             >New</span></a>
                                     </li>
                                     ...
                                     <ul class="nav nav-sm flex-column">
                                         ...
                                         <li class="nav-item">
                                             <a
                                                 ...
                                                 class="nav-link"
                                             ><span data-key="t-slope">Slope</span> <span
                                                     class="badge badge-pill bg-success"
                                                     data-key="t-new"
                                                 >New</span></a>
                                         </li>
                         ...
                         <ul class="nav nav-sm flex-column">
                             <li class="nav-item">
                                 <a
                                     ...
                                     class="nav-link"
                                 ><span data-key="t-remix">Remix</span> <span
                             ...
                             <li class="nav-item">
                                 <a
                                     ...
                                     class="nav-link"
                                 ><span data-key="t-boxicons">Boxicons</span> <span
                             ...
                             <li class="nav-item">
                                 <a
                                     ...
                                     class="nav-link"
                                 ><span data-key="t-material-design">Material Design</span> <span
                             ...
                             <li class="nav-item">
                                 <a
                                     ...
                                     class="nav-link"
                                 ><span data-key="t-feather">Feather</span> <span
